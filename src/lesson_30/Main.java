...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Question question2 = new Question("_________ you play chess?", 3);
        ...
        Question question3 = new Question("What are you doing now? I __________ a letter.", 3);
        Option option31 = new Option("is writing", false);
        Option option32 = new Option("be writing", false);
        Option option33 = new Option("am writing", true);
